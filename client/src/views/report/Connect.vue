  ...
  <section class='box'>
    ...
    <el-col :span="24" class="search">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <span class="search-label">事务标题：</span>
          <el-input v-model="filters.name"></el-input>
        </el-form-item>
        <el-form-item>
          <span class="search-label">产品线：</span>
        ...
        <el-collapse-transition>
          <div v-show="extend">
            ...
            <el-form-item>
              <span class="search-label">事务类型：</span>
              <el-select v-model="filters.status" filterable>
                <el-option
                  v-for="item in statusItems"
                  :key="item.value"
            ...
            <el-form-item>
              <span class="search-label">重要程度：</span>
    ...
    <el-table :data="users" stripe border v-loading="loading" element-loading-text='给我点时间'>
      <el-table-column prop="name" label="项目问题/需求/回访/常规事务" width="230">
      </el-table-column>
      <el-table-column prop="email" label="事务类型" align="center">
      </el-table-column>
      <el-table-column prop="status" label="重要程度" :formatter='formatStatus' align="center">
      </el-table-column>
      <el-table-column prop="vipLevel" label="客户名称" :formatter='formatVIP' align="center">
      </el-table-column>
      <el-table-column prop="vipLevel" label="产品线" align="center">
      </el-table-column>
      <el-table-column prop="vipLevel" label="提交人" align="center">
      </el-table-column>
