  ...
  <section class='box'>
    ...
    <el-col :span="24" class="search">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <span class="search-label">文档标题：</span>
          <el-input v-model="filters.name"></el-input>
        </el-form-item>
          <el-form-item>
          <span class="search-label">文档状态：</span>
        ...
        <el-form-item>
          <span class="search-label">撰写人：</span>
        ...
        <el-collapse-transition>
          <div v-show="extend">
            <el-form-item>
              ...
              <el-date-picker v-model="filters.timeValue" 
                type="datetimerange"
    ...
    <el-table :data="users" stripe border v-loading="loading" element-loading-text='玩命加载中'>
      <el-table-column prop="name" label="文档标题" width="260" align="center">
      ...
      <el-table-column prop="email" label="产品线" sortable align="center">
        <template slot-scope="scope">
          <span class="link-type" @click="handleUpdate(scope.row)">
            {{scope.row.email}}
          </span>
      ...
      <el-table-column prop="vipLevel" label="撰写人" align="center">
      </el-table-column>
