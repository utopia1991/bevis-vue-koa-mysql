  ...
  <section class='box'>
    ...
    <el-col :span="24" class="search">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <span class="search-label">项目需求：</span>
          <el-input v-model="filters.name"></el-input>
        </el-form-item>
        <el-form-item>
          <span class="search-label">客服团队：</span>
          <el-select v-model="filters.status" multiple filterable>
            <el-option
        ...
        <el-collapse-transition>
          <div v-show="extend">
            <el-form-item>
              <span class="search-label">需求状态：</span>
              <el-select v-model="filters.vip" filterable clearable>
                <el-option v-for="item in vipItems" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item>
              <span class="search-label">相关人员：</span>
              <el-input v-model="filters.email"></el-input>
            </el-form-item>
            <el-form-item>
    ...
    <el-table :data="users" stripe border v-loading="loading" element-loading-text='给我点时间'>
      <el-table-column prop="name" label="项目需求" align="center">
      </el-table-column>
      <el-table-column prop="email" label="客服团队" sortable align="center">
      </el-table-column>
      <el-table-column prop="status" label="客户名称" align="center">
      </el-table-column>
      <el-table-column prop="vipLevel" label="需求状态" align="center">
      </el-table-column>
      <el-table-column prop="vipLevel" label="提交者" align="center">
      </el-table-column>
      <el-table-column prop="vipLevel" label="接收者" align="center">
      </el-table-column>
