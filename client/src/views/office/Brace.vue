  ...
  <section class='box'>
    ...
    <el-col :span="24" class="search">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <span class="search-label">支撑项目：</span>
        ...
        <el-collapse-transition>
          <div v-show="extend">
            <el-form-item>
              <span class="search-label">支撑类型：</span>
            ...
            <el-form-item>
              <span class="search-label">支撑状态：</span>
              <el-select v-model="filters.vip" filterable clearable>
                <el-option v-for="item in vipItems" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
    ...
    <el-table :data="users" stripe border v-loading="loading" element-loading-text='给我点时间'>
      <el-table-column prop="name" label="支撑项目" align="center">
      </el-table-column>
      <el-table-column prop="email" label="客服团队" sortable align="center">
      </el-table-column>
      <el-table-column prop="status" label="支撑类型" align="center">
      </el-table-column>
      <el-table-column prop="vipLevel" label="支撑状态" align="center">
      </el-table-column>
